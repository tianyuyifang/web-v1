export default {
  ...
  awaitingApproval: "你现在可以直接登录使用。体验期内，自动打标等全部功能免费开放；体验版最多可创建 3 个歌单。",
  alreadyApproved: "现在就",
  creatingAccount: "创建中...",
  createAccount: "创建账号",
  ...
  navPricing: "定价",
  pricingTitle: "会员与定价",
  pricingSubtitle: "体验版免费使用，随时可升级成会员。",
  pricingBenefit: "权益",
  pricingGuest: "体验版",
  pricingMember: "会员版",
  pricingFree: "免费",
  ...
  benefitCapture: "自动打标",
  benefitCaptureGuest: "体验期内免费",
  benefitCaptureMember: "额外 10 元 / 月",
  pricingPriceRow: "价格",
  pricingContactTitle: "如何开通",
  pricingContactBody: "本站暂未接入在线支付，开通会员或增值功能请联系管理员：",
  viewPricing: "查看完整权益对比 →",

  // 增值功能
  addOnRequiredTitle: "自动打标需单独开通",
  addOnCaptureBody: "自动打标是会员之外的增值功能，需单独付费开通（10 元 / 月）。请联系管理员：",
  addOnNeedsSetup: "需单独开通才能使用",
  addOnsLabel: "增值功能",
  addOnCapture: "自动打标",
  captureFreeForGuest: "体验期内免费",
  captureNeedsAddOn: "需额外开通 10 元 / 月",
  permUnlimited: "无限制",
