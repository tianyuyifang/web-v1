export default {
  ...
  awaitingApproval: "You can log in and start right away. Guests can create up to 3 playlists; upgrade to a membership to lift the limit.",
  alreadyApproved: "Go ahead and",
  ...
  batch: "Batch",
  shuffleSelected: "Shuffle",
  shuffleConfirmTitle: "Shuffle selected clips",
  shuffleConfirmBody: "Shuffles the order of the {count} selected clips. Unselected clips stay where they are.",
  shuffleCrossSectionWarning: "Note: the selection spans more than one section, so clips may land in a different section. The section headings themselves do not move.",
  shuffleNeedTwo: "Select at least 2 clips",
  ...
  // Guest limits
  guestLimitTitle: "Not available to guests",
  guestNoPublic: "Guests cannot make a playlist public. Upgrade to a membership to open your playlists to everyone.",
  guestNoCopyPermission: "Guests cannot grant copy permission. You can still share a playlist with teammates so they can like and auto-tag for you. Upgrade to a membership to allow copying.",
  guestPlaylistLimitTitle: "Guest playlist limit reached",
  guestPlaylistLimitMessage: "Guests can have up to 3 playlists. Delete one you no longer need, or upgrade to a membership for unlimited playlists.",
  guestBadge: "Guest",
  ...
  roleMember: "Member",
  roleAdmin: "Admin",
  rolePending: "Disabled",
  guestNoExpiry: "No time limit yet",
  yourPermissions: "What you can do",
  permCreatePlaylists: "Create playlists",
  permShareForLikes: "Share so teammates can like and auto-tag",
  permPublicPlaylist: "Make playlists public",
  permAllowCopy: "Let others copy your playlists",
  permUnlimitedPlaylists: "Unlimited playlists",
  memberOnly: "Members only",
  upgradePromptTitle: "Upgrade to a membership",
  upgradePromptBody: "Unlock everything, with no limit on playlists. Contact an admin to get set up:",
  contactAdmin1: "Admin A: <to be filled in>",
  contactAdmin2: "Admin B: <to be filled in>",
  playlistUsage: "{used} / {max}",

  // Disabled account page
  pendingGuestExpiredTitle: "Your trial has ended",
  pendingGuestExpiredBody: "Your guest trial has ended. Become a member to carry on and unlock everything. Contact an admin:",
  pendingMemberExpiredTitle: "Your membership has expired",
  pendingMemberExpiredBody: "Your membership has expired. Contact an admin to renew:",
  pendingDefaultTitle: "Account pending",
  pendingDefaultBody: "Your account is waiting on an admin. Get in touch if you have questions:",
  feeColumn: "Fee",
