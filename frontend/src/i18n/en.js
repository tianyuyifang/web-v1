export default {
  ...
  authNoticeUsageLabel: "Usage: ",
  authNoticeUsageBody: "Free trial is open to all. To help newcomers get started, a few public playlists have been pre-set as references. Since the site is personally maintained, new users will need to wait for manual admin approval after registering — thanks for your patience.",
  authNoticePrivacyLabel: "Privacy: ",
  authNoticePrivacyBody: "You're warmly encouraged to create and share your own playlists. We also take user playlist privacy seriously.",
  authNoticeFeeLabel: "Cost: ",
  authNoticeFeeBody: "The site is currently in free-trial mode. To help cover server operating costs in the future, a monthly subscription may be introduced — with all proceeds going toward keeping the site running long-term.",
  authNoticeDisclaimerLabel: "Disclaimer: ",
  authNoticeDisclaimerBody: "This site is maintained and operated personally by the admin, who reserves final interpretation of all rules.",
  authNoticeOutro: "Thanks to every friend who loves music and logic — have a great time!",
  username: "Username",
  password: "Password",
