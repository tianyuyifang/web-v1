export default {
  ...
  authNoticeUsageLabel: "关于使用：",
  authNoticeUsageBody: "本站非常欢迎大家免费试用。为了方便新手快速上手，站长贴心地预置了一些公开歌单供大家参考使用。由于是个人维护，新用户注册后请耐心等待管理员人工通过，感谢你的配合。",
  authNoticePrivacyLabel: "关于隐私：",
  authNoticePrivacyBody: "我们非常鼓励大家制作并分享自己的歌单。同时本站也会高度重视用户歌单的隐私。",
  authNoticeFeeLabel: "关于费用：",
  authNoticeFeeBody: "目前本站处于免费试用阶段。未来为分担服务器运维成本，可能会开启「月度订阅」模式，所得费用将全部用于维持网站的长久运行。",
  authNoticeDisclaimerLabel: "免责说明：",
  authNoticeDisclaimerBody: "本站由管理员个人维护及运营，相关规则的最终解释权归站长所有。",
  authNoticeOutro: "感谢每一位热爱音乐与逻辑的小伙伴，祝大家玩得尽兴！",
  username: "用户名",
  password: "密码",
  signingIn: "登录中...",
  signIn: "登录",
